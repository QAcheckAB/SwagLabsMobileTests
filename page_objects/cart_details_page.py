...
class CartDetailsPage(DriverCommands):
    ...
    def assert_amount_of_products_in_cart(self, expected_amount: int) -> None:
        ...
        assert (
            products_amount == expected_amount
        ), f"Amount of products in cart is incorrect, expected {expected_amount} but got {products_amount}"  # noqa E501
    ...
    def assert_cart_details_page(
        self, product_index: int, expected_name: str, expected_price: str, expected_quantity: str
    ) -> None:
