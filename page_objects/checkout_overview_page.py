...
class CheckoutOverviewPage(DriverCommands):
    SELECTORS = {
        ...
        "android": (AppiumBy.ANDROID_UIAUTOMATOR, "new UiSelector().text(\"CHECKOUT: OVERVIEW\")"),
        "ios": (AppiumBy.ACCESSIBILITY_ID, ""),
    },
        "CART_ITEMS": {
            "android": (
            AppiumBy.ANDROID_UIAUTOMATOR, "new UiSelector().description(\"test-Item\")"),
            "ios": (AppiumBy.ACCESSIBILITY_ID, ""),
        },
        "PRODUCT_TEXT": {
        ...
        "ITEM_TOTAL":{
            "android": (AppiumBy.ANDROID_UIAUTOMATOR, "new UiSelector().textContains(\"Item total: $\")"),
            "ios": (AppiumBy.ACCESSIBILITY_ID, ""),
    },
        "TAX":{
        ...
        "TOTAL":{
            "android": (AppiumBy.ANDROID_UIAUTOMATOR, "new UiSelector().textContains(\"Total: $%s\")"),
            "ios": (AppiumBy.ACCESSIBILITY_ID, "")
    },
        "FINISH_BUTTON": {
